...
.sidebar .nav-links li button.active{
  background: #081D45;
}
...
<body>
  <div class="sidebar">
    <div class="logo-details">
      ...
      <span class="logo_name">Cars Hub</span>
    </div>
      <ul class="nav-links">
      <li>
          <button id="myButton" onClick="dash()">
            <i class='bx bx-box' ></i>
  ...
  <div id="phpContent" style="width: 1200px; text-align: center; margin-left:18%;"></div>
  <script>
